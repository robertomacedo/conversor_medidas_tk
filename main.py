...
b_1 = Button(frame_e, text='Massa', image=img_1, compound=LEFT, width=112, height=40, relief='flat', overrelief='solid', anchor='nw', font=('Ivy 8 bold'), bg=cor_font, fg=cor_frame)
...
b_2 = Button(frame_e, text='Tempo', image=img_2, compound=LEFT, width=112, height=40, relief='flat', overrelief='solid', anchor='nw', font=('Ivy 8 bold'), bg=cor_font, fg=cor_frame)
...
b_3 = Button(frame_e, text='Comprimento', image=img_3, compound=LEFT, width=112, height=40, relief='flat', overrelief='solid', anchor='nw', font=('Ivy 8 bold'), bg=cor_font, fg=cor_frame)
...
b_4 = Button(frame_e, text='Área', image=img_4, compound=LEFT, width=112, height=40, relief='flat', overrelief='solid', anchor='nw', font=('Ivy 8 bold'), bg=cor_font, fg=cor_frame)
b_4.grid(row=1, column=0, sticky=NSEW, padx=5, pady=5)

img_5 = Image.open('images/regua.png')
img_5 = img_5.resize((40,40), Image.ANTIALIAS)
img_5 = ImageTk.PhotoImage(img_5)
b_5 = Button(frame_e, text='Quantidade', image=img_5, compound=LEFT, width=112, height=40, relief='flat', overrelief='solid', anchor='nw', font=('Ivy 8 bold'), bg=cor_font, fg=cor_frame)
...
b_6 = Button(frame_e, text='Velocidade', image=img_6, compound=LEFT, width=112, height=40, relief='flat', overrelief='solid', anchor='nw', font=('Ivy 8 bold'), bg=cor_font, fg=cor_frame)
...
b_7 = Button(frame_e, text='Temperatura', image=img_7, compound=LEFT, width=112, height=40, relief='flat', overrelief='solid', anchor='nw', font=('Ivy 8 bold'), bg=cor_font, fg=cor_frame)
...
b_8 = Button(frame_e, text='Energia', image=img_8, compound=LEFT, width=112, height=40, relief='flat', overrelief='solid', anchor='nw', font=('Ivy 8 bold'), bg=cor_font, fg=cor_frame)
...
b_9 = Button(frame_e, text='Pressão', image=img_9, compound=LEFT, width=112, height=40, relief='flat', overrelief='solid', anchor='nw', font=('Ivy 8 bold'), bg=cor_font, fg=cor_frame)
